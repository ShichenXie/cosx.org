...
数据框的操作包括以下五类，其中英文均为 dplyr 包[^2]里面的对应函数：
...
这些操作均可以与 group_by 结合使用，从而实现分组计算。除了这几类操作，还包括行列转换、以及多个数据框合并。具体的案例见如下代码。
...
[^3]: [A data.table and dplyr tour](https://atrebas.github.io/post/2019-03-03-datatable-dplyr/)
